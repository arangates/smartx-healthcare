...
<html>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            <img src="http://style.anu.edu.au/_anu/4/images/placeholders/person.png" class="img-circle">
            <ul class="nav menu">
                ...
                <li><a href="temperature.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Temperature</a></li>
